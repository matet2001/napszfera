    ...
    <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 lg:max-w-7xl mb-5 text-primary">
        <li>
            <div class="flex items-center">
                <a href="{{ route('product.index') }}" class="mr-2 text-sm font-medium hover:text-gray-600">Termékek</a>
                ...
                @php
                    switch ($product->type) {
                        case 'meditation':
                            ...
                            $routeName = 'product.meditation';
                            break;
                        case 'audiobook':
                            $translatedType = 'Hangoskönyvek';
                            $routeName = 'product.audiobook';
                            break;
                        case 'lecture':
                            $translatedType = 'Előadások';
                            $routeName = 'product.lecture';
                            break;
                        default:
                            $translatedType = $product->type;
                            $routeName = 'product.lecture'; // Default route
                            break;
                    }
                @endphp
